...
public class DragLayout extends LinearLayout implements View.OnTouchListener, SpringListener, View.OnLongClickListener {
        ...
        if(isDraggable.get()) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(dragListener != null) {
                        dragListener.onDragFinished(x, y);
                    }
                    return true;
            }
        }
    ...
    /**
     * Sets on-long-click scale "delta" - setting 1 will result in doubling size and so forth.
     * @param scale scale in %
     */
    ...
    /**
     * Sets flag indicating whether view should intercept touch event
     * @param intercepting
     */
